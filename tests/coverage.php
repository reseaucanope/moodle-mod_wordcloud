...
/**
 * Class wordcloud_coverage information for the core subsystem.
 *
 * @package   mod_wordcloud
 * @copyright 2022 Reseau-Canope
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class wordcloud_coverage extends phpunit_coverage_info {
    ...
    protected $whitelistfiles = array('wordcloud.php');
