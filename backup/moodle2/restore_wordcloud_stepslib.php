...
/**
 * Class restore_wordcloud_activity_structure_step.
 *
...
class restore_wordcloud_activity_structure_step extends restore_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        $paths[] = new restore_path_element('wordcloud_words', '/activity/wordcloud/wordcloud_words');
    ...
    protected function process_wordcloud_words($data) {
        global $DB;
        
        $data = (object)$data;
        $data->wcid = $this->get_new_parentid('wordcloud');
        
        // insert the wordcloud_words record
        $DB->insert_record('wordcloud_words', $data);
    ...
    protected function after_execute() {
        ...
        $this->add_related_files('mod_wordcloud', 'instructions', null);
    }
