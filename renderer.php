...
<div class="wc_editor_word">
     ...
     * @return string
     */
    public function render_wordcloud_course_index_summary(wordcloud_course_index_summary $indexsummary) {
        $strplural = get_string('modulenameplural', 'wordcloud');
        ...
        foreach ($indexsummary->wordclouds as $info) {
            ...
            $link = html_writer::link(new moodle_url('/mod/wordcloud/view.php', $params), $info['cmname']);
